...
require("offline",function(r,e,n){var o=function(){function e(){return o(n,arguments)}var n={en:{},fr:{}},o=r("$").intl;return e.all=n,e}();navigator.serviceWorker&&(navigator.serviceWorker.register("offline.js",{scope:"/iceland/"}),navigator.serviceWorker.ready.then(function(r){console.info("Service Worker is ready for ",r.scope)}).catch(function(r){console.error("Registration failed with: ",r)})),e.exports._=o});
